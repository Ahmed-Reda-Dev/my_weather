...
class WeatherModel extends Equatable {
  ...
  final FutureWeather? future;

  const WeatherModel({this.location, this.current, this.forecast, this.future});
  ...
  factory WeatherModel.fromMap(Map<String, dynamic> data) => WeatherModel(
        ...
        future: data['forecast'] == null
            ? null
            : FutureWeather.fromMap(data['forecast'] as Map<String, dynamic>),
      );
  ...
  @override
  List<Object?> get props => [location, current, forecast, future];
}
