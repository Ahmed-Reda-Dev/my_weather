...
class AnimatedSplashViewText extends StatefulWidget {
  const AnimatedSplashViewText({
    Key? key,
  }) : super(key: key);

  @override
  State<AnimatedSplashViewText> createState() => _AnimatedSplashViewTextState();
}

class _AnimatedSplashViewTextState extends State<AnimatedSplashViewText>
